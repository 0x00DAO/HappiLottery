...
const DeployContractName = 'AirVoyageGameMoveSystem';
const contractAddress = ContractDeployAddress.AirVoyageGameMoveSystem;
...
async function afterDeploy(contract: Contract) {
  await contract.grantRole(
    await contract.SYSTEM_INTERNAL_ROLE(),
